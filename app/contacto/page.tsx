                ...
                <section className="max-w-7xl mx-auto px-6 py-8">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="space-y-8 animate-slide-in-left">
                            ...
                            {/* Instagram CTA */}
                            <div className="mt-6 bg-pink-50 rounded-tr-[40px] rounded-bl-[40px] p-8 text-center">
                                <div className="w-16 h-16 bg-gradient-to-tr from-purple-600 via-pink-500 to-amber-400 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-gray-600 mb-6">
                                    Descubre nuestros productos, novedades y consejos para panadería, repostería y pastelería.
                                </p>
                                <a
                                    href="https://instagram.com/adaisoluciones"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 via-pink-500 to-amber-500 hover:from-purple-700 hover:via-pink-600 hover:to-amber-600 text-white font-semibold px-8 py-4 rounded-tr-[30px] rounded-bl-[30px] transition-colors uppercase tracking-wide btn-animate"
                                    style={{ fontSize: "13px" }}
                                >
                                    VER INSTAGRAM
