...
export default function Footer() {
    return (
        <footer className="bg-[#1e2330] text-gray-300 py-16">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-white font-serif text-lg mb-6">Enlaces Rápidos</h3>
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link href="/consultoria" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    Consultoría
                                </Link>
                            </li>
                        </ul>
                    ...
                    {/* Social Media */}
                    <div>
                        <h3 className="text-white font-serif text-lg mb-6">Redes Sociales</h3>
                        <div className="flex gap-3 mb-8">
                            {/* Facebook */}
                            <a
                                href="https://facebook.com/adaisoluciones"
                                target="_blank"
                        ...
                        {/* Subscribe */}
                        <h3 className="text-white font-serif text-lg mb-4">Suscríbete</h3>
                        <form className="flex">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-700 border-0 rounded-l-lg py-3 pl-10 pr-4 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500"
                                />
                            </div>
                            <button
                                type="submit"
                                className="bg-white hover:bg-gray-100 text-gray-800 px-6 py-3 rounded-r-lg text-sm font-medium transition-colors"
                            >
                                Enviar
                            </button>
                        </form>
